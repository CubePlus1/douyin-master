...
setTimeout(() => {
  ...
  console.log('[douyin] App mounted successfully')
} catch (e) {
  console.error('[douyin] App init error:', e)
  document.getElementById('app')!.innerHTML = `<div style="color:red;padding:20px;"><h2>启动错误</h2><pre>${e}</pre></div>`
}
