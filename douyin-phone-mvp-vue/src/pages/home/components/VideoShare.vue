    ...
    ToShare: {
      ...
      render() {
        return (
          ...
          >
            <div className={this.itemType === 'debate' ? 'wrapper debate-wrapper' : 'wrapper'}>
              {this.loading ? (
                <div className="loading-wrapper" style="width: 80%;height: 80%;">
                  <LoadingCircle v-model={this.progress} />
                </div>
              ) : (
                this.itemType === 'debate' ? (
                  <img
                    className="debate-entry-img"
                    src="/assets/img/icon/components/video/daodun.jpg"
                    alt=""
                  />
                ) : (
  ...
  :deep(.shares) {
    ...
    .to {
      ...
      .wrapper {
        ...
        &.debate-wrapper {
          background: #ffd5e3;
          box-shadow: 0 8rem 18rem rgba(254, 44, 85, 0.3);
        }
